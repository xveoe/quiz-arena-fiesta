    ...
    <div className="flex flex-col space-y-2">
      <div className="flex items-center gap-2">
        <Input
          ...
          className="modern-input flex-grow bg-white text-gray-800 rounded-xl border-blue-100 focus:border-blue-400"
        />
        <Button
          onClick={handleAddCategory}
          disabled={customCategory.trim().length === 0}
          className="px-3 py-2 rounded-xl bg-blue-500 hover:bg-blue-600 text-white"
        >
