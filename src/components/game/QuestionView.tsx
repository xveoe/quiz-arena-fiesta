...
const QuestionView: React.FC<QuestionViewProps> = ({
  ...
  if (!questions || questions.length === 0 || currentQuestionIndex >= questions.length) {
    return <div className="text-center text-red-500 font-bold">لم يتم العثور على أسئلة</div>;
  }
          ...
          {currentQuestion.options.map((option, index) => (
            ...
            >
              <Button
                ...
                className={`
                  w-full justify-start text-right py-3.5 px-4 transition-all rounded-xl
